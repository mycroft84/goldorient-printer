...
return [
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR','Karcsics Tibor'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'GoldOrient Printer'),

    /**
     * The Website of your application.
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://goldorient.hu'),
    ...
    'prebuild' => [
        ...
        'cmd /c "if exist nativephp\\electron\\build rd /s /q nativephp\\electron\\build"',
        'cmd /c "if exist nativephp\\electron\\dist rd /s /q nativephp\\electron\\dist"',
        'del /f /q public\\hot',
